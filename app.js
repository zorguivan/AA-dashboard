...
// Update User
app.put('/api/updateUser/:id', function (req, res, next) {
...
// Create a new File
app.post("/api/pdf", upload.single("file"), async function (req, res) {
...
app.post('/api/send-email', function (req, res) {
  let transporter = nodeMailer.createTransport({
    ...
    secure: true,
    auth: {
      user: 'contact.aabusinessfl@gmail.com',
      pass: 'awccsooyasjezqyy'
    }
  });


  userSchema.findById(req.body.id, (error, user) => {
    let mailOptions = {
      from: '"AA Business Florida" <contact.aabusinessfl@gmail.com>', // sender address
      to: [user.email, "aabusinessfl@hotmail.com"], // list of receivers
      subject: user.firstName + ' ' + user.lastName + ' - AABusiness Invoice N:' + req.body.id, // Subject line
      html: Invoice(user, req.body.price, req.body.product, req.body.invId) // html body
    };
